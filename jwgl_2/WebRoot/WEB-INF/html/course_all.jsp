...
<html lang="zh">
    ...
    <script type="text/javascript" src="js/data/courseSelect.js" ></script>
    <title>教务管理系统</title>
...
.tableB {
 ...
 --> 
      			...
      			<!-- Start -->		
					...
					<div class="well" style="float:left">
						<div style="float:left;margin:8px auto">
							<a class="addCst"><span class="ui-icon ace-icon fa fa-plus fa-2x center bigger-110 blue"></span></a>
						</div>
						<div style="float:left;margin:0 10px">
							<form action="cst-find" method="post" target="_parent"
								style="float:left">
								<table>
									<tr>
										<td><label>请输入课程名称:</label><input type="text" name="cst.cname" value=""></td>
						...
						<div style="float:left">
							<a href="cst-getCsAll" style="float:left"><span
				...
				<!-- getCst -->
					<div class="tableS">
						<table class=" table table-striped table-bordered table-hover ">
							...
							<tbody class="">
								<s:iterator var="cst" value="cstList">
									<tr>
										<td><a class="modify"
											lang="id=${cst.id}&cno=${cst.cno}&cname=${cst.cname}&tname=${cst.tname}&chour=${cst.chour}&examway=${cst.examway}"><i class="ace-icon fa fa-pencil"></i></a></td>
										<td><a lang="${cst.cno}" class="delete"><i class="ace-icon fa fa-trash-o"></i></a></td>
										<td><s:property value="%{#cst.id}" /></td>
										<td><s:property value="%{#cst.cno}" /></td>
										<td><s:property value="%{#cst.cname}" /></td>
										<td><s:property value="%{#cst.tname}" /></td>
										<td><s:property value="%{#cst.chour}" /></td>
										<td><s:property value="%{#cst.examway}" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
	...
	<script type="text/javascript" src="js/jqGrid/jqgrid_course_all.js"></script>
