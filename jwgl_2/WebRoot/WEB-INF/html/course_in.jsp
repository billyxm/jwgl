      ...
      <div class="page-content" >	
      	...
      	<div class="row">
      		<div class="well well-sm">
				...
				温馨提示：如果你想查询选课是否请返回<a href="reg_stu">上一层</a>查询。
				<i class="fa fa-external-link bigger-110"></i>		
			</div>
      		<div class="col-xs-12" ><!--分割线的设计-->
      			<!--内容开始-->
      			<form class="form-horizontal"  action="cst-save" method="post" target="_parent">
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程编号:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="cst.cno"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程名称:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="cst.cname"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程任课老师：</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="cst.tname"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程学时:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="cst.chour"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程考核方式:</label>
      					<div class=col-sm-2>
      						<select name="cst.examway" id="" class="form-control">
