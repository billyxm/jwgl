				...
				<div style="position: relative;">
					...
					<li class="hsub">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text">师资管理 </span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						<b class="arrow"></b>
						<ul class="submenu " >
							<li class>
								<a href="teacher-getTeacher" >
           ...
           <div class="pageBox1" style="float: left;"><!--第一个板块-->
           		<div class="center">
           			...
           			<span class="Box1-btn btn btn-yellow pageBox1-s no-hover">
           				...
           				<span><h4>课程管理</h4></span>
           			</span></a>
           			<a href="student-getStudent">
           			<span class="Box1-btn btn btn-pink pageBox1-s no-hover">
           				<i class="fa fa-calendar fa-4x"></i>
           				<span><h4>学生信息</h4></span>
           			</span></a>
           			<a href="teachTask-getTeachTask">
           			<span class="Box1-btn btn btn-grey pageBox1-s no-hover">
           				<i class="fa fa-file-text fa-4x"></i>
           				<span><h4>教学任务</h4></span>
           			</span></a>     	
           </div></div>
