      ...
      <div class="page-content" >	
      	...
      	<div class="row">
      		<div class="col-xs-12 pageBox2" ><!--分割线的设计-->
      			<!--内容开始-->
      			<form class="student-save" action="student-save" target="_parent">
      				<table>
      					<tbody>
      						<tr>
      							<td ><label>学号</label></td>
      							<td><input type="text" name="stu.sno" width="80px"></td>
      							<td><label>姓名</label></td>
      							<td><input type="text" name="stu.sname" width="50px"></td>
      							<td><label>曾用名</label></td>
      							<td><input type="text" name="stu.beforename" width="80px"></td>
      						</tr>
      						<tr>
      								<td><label>籍贯</label></td>
	      							<td><input type="text" name="stu.natived"></td>
	      							<td></td>
	      							<td></td>
	      							<td><label>英文名</label></td>
      							<td><input type="text" name="stu.engname" width="50px"></td>
      						</tr>
      						<tr>
      							<td><label>拼音首字母</label></td>
      							<td><input type="text" name="stu.pinyin" width="50px"></td>
      							<td><label>国家</label></td>
      							<td><input type="text" name="stu.country" width="50px"></td>
      							<td><label>性别</label></td>
      							<td>
      								<select name="stu.ssex" class="form-control">
      						...
      						<tr>
      							...
      							<td>
      								<select name="stu.politicsstatus" id=""class="form-control">
      									<option value="">请选择</option>
      									<option value="群众">群众</option>
      									<option value="预备党员">预备党员</option>
      									<option value="中国党员">中国党员</option>
      									<option value="共青团员">共青团员</option>
      									<option value="其他党派成员">其他党派成员</option>
      								</select>
      							</td>
      							<td><label>证件类型</label></td>
      							<td>
      								<select name="stu.idtype" class="form-control">
      									<option value="">请选择</option>
      									<option value="身份证">身份证</option>
      									<option value="houseBook">户口本</option>
      									<option value="Military card">军人证件</option>
      									<option value="shortId">临时身份证</option>
      									<option value="hmt">港澳台同胞</option>
      									<option value="passport">外国友人护照</option>
      								</select>
      							</td>
      							<td><label>证件号</label></td>
      							<td><input type="text" name="stu.idnum" width="100px"></td>
      						</tr>
      						<tr>
      							<td><label>民族</label></td>
      							<td>
      								<select name="stu.nation" class="form-control">
									    <option value="">请选择</option>
      							...
      							<td><label>学籍状态</label></td>
      							<td><input type="text" name="stu.status" width="50px"></td>
      							<td><label>学制</label></td>
      							<td><input type="text" name="stu.stutime" width="50px"></td>
      						</tr>
      						<tr>
      							<td><label>原学号</label></td>
      							<td><input type="text" name="stu.beforeid" width="50px"></td>
      							<td></td>
      							<td></td>
      							<td><label>登录密码</label></td>
      							<td><input type="text" name="stu.password" width="50px"></td>
      						</tr>
      						<tr>
      							<td><label>外语语种</label></td>
      							<td>
      								<select name="stu.forlang" class="form-control">
      									<option value="">请选择</option>
      									<option value="英语">英语</option>
      									<option value="other">小语种</option>
      								</select>
      							</td>
      							<td><label>出生年月日</label></td>
      							<td><!-- data-date-format="yyyy-mm-dd" -->
      								<input class="form-control date-picker" id="id-date-picker-1" type="text"  name="stu.borndate" onClick="pickDate()" >
      								<script type="text/javascript">
      							...
      							<td><label>班内序号</label></td>
      							<td><input type="text" name="stu.classid" width="50px"></td>
      						</tr>
      						<tr>
								<td><label>专业</label></td>
      							<td><input type="text" name="stu.major" width="50px"></td>
      							<td><label>班级</label></td>
      							<td><input type="text" name="stu.classnum" width="50px"></td>
      							<td>
      								<div class="divbutton"><button class="btn btn-sm btn-re" type="reset">
										<i class="ace-icon fa fa-undo bigger-110"></i>
											重置
									</button></div>
								</td>
								<td>
									<div class="divbutton"><button type="submit" class="btn btn-sm btn-success btn-su">提交
