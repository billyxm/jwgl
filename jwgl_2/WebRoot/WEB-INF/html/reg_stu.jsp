      ...
      <div class="page-content" >	
      	...
      	<div class="row ">
      		...
      		<!--
              	...
              	描述：
              -->
            <div class="col-sm-7 Box-center center" ><!--分割线的设计-->
      			<!--内容开始-->
      			<div class="widget-box">
      				...
      				<div class="widget-body">
      					<div class="widget-main">
      						...
      						<div>
      							<label class="llabel-success">学号为1382051的学生已经注册！</label>
      							<label class="llabel-success">学号为1382051的学生未注册！</label>
      						</div>
      					</div>
      				</div>
      		</div>
