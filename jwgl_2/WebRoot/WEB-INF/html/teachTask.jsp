...
<%@ page import="jwgl.action.TeachTaskAction" %>
<%
...
<html lang="zh">
    ...
    <script type="text/javascript" src="js/data/teachTask.js" ></script>
    <title>教务管理系统</title>
...
.tableS {
 ...
 --> 
      			...
      			<!--内容开始-->
					...
					<div class="well" style="float:left">
						<div style="float:left;margin:8px auto">
							<a class="addTeachTask"><span class="ui-icon ace-icon fa fa-plus fa-2x center bigger-110 blue"></span></a>
						</div>
						<div style="float:left;margin:0 10px">
							<form action="teachTask-find" method="post" target="_parent"
								style="float:left">
								<table>
									<tr>
										<td><label>请输入姓名:</label><input type="text" name="cs.tname" value=""></td>
						...
						<div style="float:left">
							<a href="teachTask-getTeachTask" style="float:left"><span
						...
						<table class=" table table-striped table-bordered table-hover ">
							...
							<tbody class="">
								<s:iterator var="cs" value="csList">
									<tr>
										<td><a class="modify"
											lang="id=${cs.id}&year=${cs.year}&term=${cs.term}&classnum=${cs.classnum}&cname=${cs.cname}&tname=${cs.tname}&chour=${cs.chour}&begin=${cs.begin}&end=${cs.end}&examway=${cs.examway}&classsite=${cs.classsite}&classtime=${cs.classtime}&examtime=${cs.examtime}"><i class="ace-icon fa fa-pencil"></i></a></td>
										<td><a lang="${cs.tname}" class="delete"><i class="ace-icon fa fa-trash-o"></i></a></td>
										<td><s:property value="%{#cs.id}" /></td>
										<td><s:property value="%{#cs.year}" /></td>
										<td><s:property value="%{#cs.term}" /></td>
										<td><s:property value="%{#cs.classnum}" /></td>
										<td><s:property value="%{#cs.cname}" /></td>
										<td><s:property value="%{#cs.tname}" /></td>
										<td><s:property value="%{#cs.chour}" /></td>
										<td><s:property value="%{#cs.begin}" /></td>
										<td><s:property value="%{#cs.end}" /></td>
										<td><s:property value="%{#cs.examway}" /></td>
										<td><s:property value="%{#cs.classsite}" /></td>
										<td><s:property value="%{#cs.classtime}" /></td>
										<td><s:property value="%{#cs.examtime}" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
	...
	<script type="text/javascript" src="js/jqGrid/jqgrid_task.js"></script>
