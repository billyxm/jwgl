				...
				<!-- Start -->		
					...
					<div class="well" style="float:left">
						<div style="float:left;margin:0 10px">
							<form action="CourseSelect-stu-save" method="post" target="_parent"
								style="float:left">
								<table>
									<tr>
										<td><label>请输入你要选择课程编号:</label><input type="text" name="cs.cno" value=""></td>
						...
						<table class=" table table-striped table-bordered table-hover ">
							...
							<tbody class="">
								<s:iterator var="cst" value="cstList">
									<tr>
										<td name="cs.id"><s:property value="%{#cst.id}" /></td>
										<td name="cs.cno"><s:property value="%{#cst.cno}" /></td>
										<td name="cs.cname"><s:property value="%{#cst.cname}" /></td>
										<td name="cs.tname"><s:property value="%{#cst.tname}" /></td>
										<td name="cs.chour"><s:property value="%{#cst.chour}" /></td>
										<td name="cs.examway"><s:property value="%{#cst.examway}" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
