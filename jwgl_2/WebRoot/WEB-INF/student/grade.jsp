      		...
      		<div class="col-xs-12"><!--分割线的设计-->
      			...
      			<div class="tableS">
						<table class=" table table-striped table-bordered table-hover ">
							...
							<tbody class="">
								<s:iterator var="ga" value="gradeList">
									<tr>
										<td><s:property value="%{#ga.id}" /></td>
										<td><s:property value="%{#ga.cno}" /></td>
										<td><s:property value="%{#ga.cname}" /></td>
										<td><s:property value="%{#ga.grade}" /></td>
										<td><s:property value="%{#ga.way}" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
