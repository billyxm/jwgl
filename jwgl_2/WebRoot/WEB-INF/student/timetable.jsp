                ...
                4 <!--此处是消息的条数-->
                  ...
                  学生${session.sname }
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="profile-stu">
										<i class="ace-icon fa fa-user"></i> 简介
									</a>
								</li>
								<li class="divider"></li>
								<li>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div>
							<table class=" table table-striped table-bordered table-hover tableTime "><thead><th></th>
							<th>星期一</th>
							<th>星期二</th>
							<th>星期三</th>
							<th>星期四</th>
							<th>星期五</th></thead><tbody>
								<tr>
									<td style="background-color:#E3EAF4;border-color:#999999;border-width:1px;border-style:Solid;">第一、二节</td>
									<td ><s:property value="%{ti.m1}" /></td>
									<td><s:property value="%{ti.tu1}" /></td>
									<td><s:property value="%{ti.w1}" /></td>
									<td><s:property value="%{ti.th1}" /></td>
									<td><s:property value="%{ti.f1}" /></td>
								</tr>
								<tr>
									<td style="background-color:#E3EAF4;border-color:#999999;border-width:1px;border-style:Solid;">第三、四节</td>
									<td><s:property value="%{ti.m2}" /></td>
									<td><s:property value="%{ti.tu2}" /></td>
									<td><s:property value="%{ti.w2}" /></td>
									<td><s:property value="%{ti.th2}" /></td>
									<td><s:property value="%{ti.f2}" /></td>
								</tr>
								<tr>
									<td style="background-color:#E3EAF4;border-color:#999999;border-width:1px;border-style:Solid;">第五、六节</td>
									<td><s:property value="%{ti.m3}" /></td>
									<td><s:property value="%{ti.tu3}" /></td>
									<td><s:property value="%{ti.w3}" /></td>
									<td><s:property value="%{ti.th3}" /></td>
									<td><s:property value="%{ti.f3}" /></td>
								</tr>
								<tr>
									<td style="background-color:#E3EAF4;border-color:#999999;border-width:1px;border-style:Solid;">第七、八节</td>
									<td><s:property value="%{ti.m4}" /></td>
									<td><s:property value="%{ti.tu4}" /></td>
									<td><s:property value="%{ti.w4}" /></td>
									<td><s:property value="%{ti.th4}" /></td>
									<td><s:property value="%{ti.f4}" /></td>
								</tr>
								<tr>
									<td style="background-color:#E3EAF4;border-color:#999999;border-width:1px;border-style:Solid;">第九、十节</td>
									<td><s:property value="%{ti.m5}" /></td>
									<td><s:property value="%{ti.tu5}" /></td>
									<td><s:property value="%{ti.w5}" /></td>
									<td><s:property value="%{ti.th5}" /></td>
									<td><s:property value="%{ti.f5}" /></td>
								</tr>
							</tbody></table>
						</div>
					</div>
