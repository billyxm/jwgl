      ...
      <div class="page-content" >	
      	...
      	<div class="row">
      		<div class="col-xs-12"><!--分割线的设计-->
      			<!--内容开始-->
      			<div class="Box">
           <div class="pageBox2" style="float: left;"><!--第一个板块-->
           		<div class="center">
           			<a href="grade_in-tea-in">
           			<span class="Box1-btn btn btn-light pageBox1-s no-hover">
           				<span><i class="fa fa-plus-square fa-4x"></i></span>
           				<span><h5>成绩录入</h5></span>
           			</span></a>
           			<a href="grade_rebuild-tea">
           			<span class="Box1-btn btn btn-pink pageBox1-s no-hover">
           				<i class="fa fa-frown-o fa-4x"></i>
           				<span><h5>重修/免修管理</h5></span>
           			</span></a>
           			<a href="grade_print-tea">
           			<span class="Box1-btn btn btn-grey pageBox1-s no-hover">
           				<i class="fa fa-print fa-4x"></i>
           				<span><h5>打印报表管理</h5></span>
           			</span></a>
           </div></div>
      		</div>
      	</div>
