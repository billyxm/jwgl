     ...
     <div id="sidebar" class="sidebar responsive">
        ...
        <div style="position: relative;">
          ...
          <li class="">
					...
					<li class="hsub">
						<a href="student-tea" class="dropdown-toggle">
      ...
      <div class="page-content" >	
      	...
      	<div class="row">
      		<div class="col-xs-12" ><!--分割线的设计-->
      			<!--内容开始-->
      			<form class="form-horizontal"  action="grade_in-tea-save"  target="_parent" method="post" >
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入你的学号:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="ga.sno"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入你的课程编号:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="ga.cno"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 你的课程名称:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="ga.cname"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入课程成绩:</label>
      					<div class=col-sm-2>
      						<input class="form-control" type="text" name="ga.grade"/>
      					</div>
      				</div>
      				<div class="form-group">
      					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 通过状态:</label>
      					<div class=col-sm-2>
      						<select name="ga.way"  id="" class="form-control">
      							<option value="">请选择</option>
      							<option value="success">通过</option>
      							<option value="worse">未通过</option>
      						</select>
      					</div>
      				</div>
      				<div class="form-group ">
      					<div class="col-sm-4 ">
      						<button class="btn btn-sm btn-re " type="reset">
								<i class="ace-icon fa fa-undo bigger-110"></i>重置
      						</button>
      					</div>
      					<div class="col-sm-1">
      						<button type="submit" class="btn btn-sm btn-success btn-su">提交
